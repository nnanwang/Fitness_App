...
const FitnessCards = () => {
  const FitnessData = fitness; // Storing the imported fitness data in a constant for use in this component
    ...
    <View style={{marginTop: 80, marginHorizontal: 20, marginBottom: 20}}>
      {
        FitnessData.map((item, id) => (
          // TouchableOpacity for each fitness item, navigates to "Workout" screen on press
